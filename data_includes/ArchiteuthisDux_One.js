...
[["MODALITYNEGATION-necessarynot",2], DS, {s:"+"}, {s:"In 'He mustn't panic. The bears in the area will attack him otherwise.', 'He mustn't panic' means",as: [['s','It is necessary that he does not panic.'],['k','It is not necessary that he panics.']]}],
[["MODALITYNEGATION-notnecessary",3], DS, {s:"+"}, {s:"In 'She mustn't be sad. Her mom will find the doll.', 'She mustn't be sad' means",as: [['s','It is necessary that she is not sad.'],['k','It is not necessary that she is sad.']]}], 
